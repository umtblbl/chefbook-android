package com.app.chefbook.ui.adapters.galleryPicture
...
class GalleryPicturesAdapter(private val list: List<GalleryPicture>) : RecyclerView.Adapter<GalleryPictureViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GalleryPictureViewHolder, pos: Int) {
